...
prinCP=[]
try:
    prox= requests.get('https://github.com/SSC-LOL/Haaaaaaaa/upload/main').py
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/SSC-LOL/Haaaaaaaa/upload/main').text
        ua=open('bbnew.txt','w')
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/SSC-LOL/Haaaaaaaa/upload/main').text
    if id in httpCaht:
      print(fuckyoursali)
...
def menu():
    ...
    if ASHIK in ['111']:
        ...
        os.system('xdg-open https://github.com/SSC-LOL/Haaaaaaaa/upload/main')
        os.system("python nono.py")
    elif ASHIK in ['3','03']:
        result()
    elif ASHIK in ['0']:
